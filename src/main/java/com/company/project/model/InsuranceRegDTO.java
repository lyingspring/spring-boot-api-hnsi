...
public class InsuranceRegDTO {
    private String aac003;
    private String aae135;
    private String aae140;
    private String aae016;//审核标志
    private String aae013;
    private String ead184;//业务流水号(银行接口使用)
    private String aae036;//申请时间
    private String aae037;//审核时间
    private String aab033;//征收方式
    private Integer aaz002;
    private String aae009;//开户名
    private String aae010;//银行账号
    private String aaa082;//银行账户激活状态：0未激活，1已激活（用途）
    private Double ead186;//应收金额
    ...
    public void setEad189(String ead189) {
        this.ead189 = ead189;
    }
    ...
    public Integer getAaz002() {
        return aaz002;
    }

    public void setAaz002(Integer aaz002) {
        this.aaz002 = aaz002;
    }
    ...
    public Double getEad186() {
        return ead186;
    }

    public void setEad186(Double ead186) {
        this.ead186 = ead186;
    }
